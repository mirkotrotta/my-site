    ...
    <Layout>
      ...
      <section className="bg-white dark:bg-gray-900">
          <HeroWithSidebar
            ...
            primaryCta={{ text: "Fallstudien", href: "/de/projects" }}
            secondaryCta={{ text: "Lebenslauf herunterladen", href: "/de/resume" }}
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="md:grid md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-8">
            ...
            <div className="mt-6">
              <Button href="/de/about" variant="link" showArrow size="lg" className="px-0">
                Mehr erfahren
              </Button>
            </div>
          </div>
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="flex justify-between items-center mb-8">
          ...
          <Button href="/de/projects" variant="primary" showArrow size="lg">
      ...
      <div className="-mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 mb-16">
        <GlobalCTA 
          ...
          buttonHref="/de/contact"
          buttonTextSecondary="Lebenslauf ansehen"
          buttonHrefSecondary="/de/resume"
        />
      </div>
    </Layout>
  );
