...
export default function Home() {
  ...
  // Although this page is in /de, the hook determines language dynamically,
  // so we still need this check for type safety.
  const currentLanguageKey = (language === 'en' || language === 'de') ? language : 'de'; // Default to 'de' just in case
  ...
  return (
    <Layout>
        ...
        <div className="md:grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-4 mb-8 md:mb-0">
            <div className="relative aspect-auto max-w-sm mx-auto overflow-hidden bg-gray-100 dark:bg-gray-800">
              <img 
                ...
                alt={t('homepage.about.imageAlt')} // Fetches from de.json
          ...
          <div className="md:col-span-8">
            ...
            <div className="prose dark:prose-invert">
              {/* Using dangerouslySetInnerHTML for HTML in translations */}
      ...
      <section className="py-16">
        ...
        {/* Skills data remains dynamically loaded based on detected language */}
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        ...
        {/* Project data remains dynamically loaded */}
