...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  const lang = 'de'; // Fixed to German for this route
  ...
  return {
    ...
    description: frontmatter.summary || `${frontmatter.title} - Lesen Sie den vollständigen Artikel auf Mirko Trottas Blog.`,
    openGraph: {
